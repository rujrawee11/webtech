...
// 1
    ...
    var p12 = document.createTextNode("ข้อแนะนำการเข้าร่วมกิจกรรมเพื่อขอรับรองชั่วโมงจิตอาสา");
    div22.appendChild(div32);
    div32.appendChild(p12);

    var div42 = document.createElement('a');
    div42.setAttribute("class","cta");
    div22.appendChild(div42);
    ...
    var p13 = document.createTextNode("การตรวจสอบการรับรองย้อนหลัง");
    ...
    var p14 = document.createTextNode("เงื่อนไขการตรวจสอบการรับรองย้อนหลัง");
    ...
    idiv44.appendChild(ic4);
    div44.appendChild(idiv44);

    setpage3()
    setpage4()

    var click = document.getElementById("but-loadques-active");
    click.setAttribute("onclick","add2()");
}
function add2(){
    let allcard =document.getElementById('allcard')
// 1
    var div1 = document.createElement('div');
    div1.setAttribute("class","ques-card2-9");
    div1.setAttribute("style","width:500px; height:100px; border-radius: 10px;");
    allcard.appendChild(div1);
    ...
    var div3 =document.createElement('p');
    div3.setAttribute("style","font-size: 16px;");
    var p1 = document.createTextNode("ระยะเวลาในการดำเนินการรับรอง");
    div2.appendChild(div3);
    div3.appendChild(p1);
    ...
    // 2
    var div12 = document.createElement('div');
    div12.setAttribute("class","ques-card2-10");
    div12.setAttribute("style","width:500px; height:100px; border-radius: 10px;");
    allcard.appendChild(div12);
    ...
    var div32 =document.createElement('p');
    div32.setAttribute("style","font-size: 16px;");
    var p12 = document.createTextNode("ไม่ได้รับการรับรองในเวลาที่กำหนด");
    div22.appendChild(div32);
    div32.appendChild(p12);
    ...
    // 3
    var div13 = document.createElement('div');
    div13.setAttribute("class","ques-card2-11");
    div13.setAttribute("style","width:500px; height:100px; border-radius: 10px;");
    allcard.appendChild(div13);
    ...
    var div33 =document.createElement('p');
    div33.setAttribute("style","font-size: 16px;");
    var p13 = document.createTextNode("การแก้ไขข้อมูลในเอกสารรับรอง/เกียรติบัตร");
    div23.appendChild(div33);
    div33.appendChild(p13);
    ...
    // 4
    var div14 = document.createElement('div');
    div14.setAttribute("class","ques-card2-12");
    div14.setAttribute("style","width:500px; height:100px; border-radius: 10px;");
    allcard.appendChild(div14);
    ...
    var div34 =document.createElement('p');
    div34.setAttribute("style","font-size: 16px;");
    var p14 = document.createTextNode("ขอคืนเงินค่าบริการ/ดำเนินการขอการรับรอง");
    div24.appendChild(div34);
    div34.appendChild(p14);
    ...
    var click = document.getElementById("but-loadques-active");
    click.setAttribute("onclick","add3()");
}
...
// 1
    var div1 = document.createElement('div');
    div1.setAttribute("class","ques-card2-13");
    div1.setAttribute("style","width:500px; height:100px; border-radius: 10px;");
    allcard.appendChild(div1);
    ...
    var div3 =document.createElement('p');
    div3.setAttribute("style","font-size: 16px;");
    var p1 = document.createTextNode("การดำเนินการเปลี่ยนประเภทการรับรอง");
    div2.appendChild(div3);
    div3.appendChild(p1);
    ...
    // 2
    var div12 = document.createElement('div');
    div12.setAttribute("class","ques-card2-14");
    div12.setAttribute("style","width:500px; height:100px; border-radius: 10px;");
    allcard.appendChild(div12);
    ...
    var div32 =document.createElement('p');
    div32.setAttribute("style","font-size: 16px;");
    var p12 = document.createTextNode("ปัญหาการจัดส่งทางไปรษณีย์");
    div22.appendChild(div32);
    div32.appendChild(p12);
